 ...
 */
export declare type UseVisualElement<E, P = MotionProps> = (Component: string | React.ComponentType<P>, props: MotionProps & P, parent?: VisualElement, isStatic?: boolean, ref?: Ref<E>) => VisualElement;
/**
